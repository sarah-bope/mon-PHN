...
public class GestionProduits {
    ...
    public String afficherProduits() {
        ...
        sb.append("LISTE DES PRODUITS (").append(produits.size()).append(")\n");
    ...
    public boolean acheterProduit(int idProduit, int quantite) {
        ...
        if (produit == null || quantite > produit.getQuantite()) return false;
    ...
    public void ajouterProduit(String nom, double prix, int quantite, String categorie) {
        int id = produits.size() + 1;

        Produit nouveauProduit = null;
        switch (categorie.toLowerCase()) {
            case "ordinateur":
                nouveauProduit = new Ordinateur(id, nom, prix, quantite, "Intel i5", 8, 15.6);
                break;
            case "telephone":
                nouveauProduit = new Telephone(id, nom, prix, quantite, "Samsung", 128, 12);
                break;
            case "accessoire":
                nouveauProduit = new Accessoire(id, nom, prix, quantite, "Universel", "USB");
                break;
            default:
                return;
        }
    ...
    public boolean modifierStockParId(int id, int nouvelleQuantite) {
        Produit produit = trouverProduitParId(id);
    ...
    public List<Produit> getProduitsParCategorie(String categorie) {
        return produits.stream()
                .filter(p -> {
                    ...
                    switch (categorie.toLowerCase()) {
                        case "ordinateur": return p instanceof Ordinateur;
                        case "telephone": return p instanceof Telephone;
                        case "accessoire": return p instanceof Accessoire;
    ...
    private Produit creerProduitSelonCategorie(int id, String nom, double prix, int quantite, String categorie, Scanner scanner) {
        switch (categorie.toLowerCase()) {
            case "ordinateur":
